...
for(i in 1:length(contents)){
  ...
  # Condition 3: some emails are generated by some system
  if((is_empty(To) || is_empty(From)) || nchar(From) > 100 || grepl("recipients", To, fixed = TRUE)){
    next
  }
...
rm(list = c("t", "Subject", "To", "From", "lines", "contents", "allFiles", "i", "df"))